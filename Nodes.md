# Информация устарела и может быть неверной!

См. [источник](https://github.com/Strupervlg/decision-tree-interface/releases).
...
**Важно**!
При написании выражения для узла "Цикл" новая переменная цикла **должна** записываться как локальная — с префиксом `$`, т.е., к примеру, `$M`, а не `var:M`: 
